...
public class SnsStack extends Stack {
    ...
    public SnsStack(final Construct scope, final String id, final StackProps props) {
        ...
        productEventsTopic = SnsTopic.Builder.create(Topic.Builder.create(this, "product-events-topic")
                        .topicName("product-events")
                        .build())
                .build();

        productEventsTopic.getTopic().addSubscription(EmailSubscription.Builder.create("gemok21167@ehwit.com")
                .json(true)
                .build());
    }
